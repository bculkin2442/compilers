...
class_objTab:
	...
	.word	String_protObj
	.word	String_init
	.word	StackOpr_protObj
	.word	StackOpr_init
	.word	IntStackOpr_protObj
	.word	IntStackOpr_init
	.word	PlusStackOpr_protObj
	.word	PlusStackOpr_init
	.word	SStackOpr_protObj
	.word	SStackOpr_init
	.word	List_protObj
	.word	List_init
	.word	Cons_protObj
...
StackOpr_dispTab:
	...
	.word	Object.type_name
	.word	Object.copy
	.word	StackOpr.printme
SStackOpr_dispTab:
	.word	Object.abort
	.word	Object.type_name
	.word	Object.copy
	.word	SStackOpr.printme
PlusStackOpr_dispTab:
	.word	Object.abort
	.word	Object.type_name
	.word	Object.copy
	.word	PlusStackOpr.printme
IntStackOpr_dispTab:
	.word	Object.abort
	.word	Object.type_name
	.word	Object.copy
	.word	IntStackOpr.printme
	.word	IntStackOpr.make
	.word	IntStackOpr.sval
	.word	IntStackOpr.gval
String_dispTab:
	.word	Object.abort
	.word	Object.type_name
	.word	Object.copy
...
StackOpr_protObj:
	.word	6
	.word	3
	.word	StackOpr_dispTab
	.word	-1
SStackOpr_protObj:
	.word	9
	.word	3
	.word	SStackOpr_dispTab
	.word	-1
PlusStackOpr_protObj:
	.word	8
	.word	3
	.word	PlusStackOpr_dispTab
	.word	-1
IntStackOpr_protObj:
	.word	7
	.word	4
	.word	IntStackOpr_dispTab
	.word	int_const0
	.word	-1
String_protObj:
	.word	5
...
IntStackOpr.make:
	...
	move	$s0 $a0
	sw	$s1 0($fp)
	la	$a0 IntStackOpr_protObj
	jal	Object.copy
	jal	IntStackOpr_init
	move	$s1 $a0
	lw	$a0 16($fp)
	sw	$a0 0($sp)
	addiu	$sp $sp -4
...
label171:
	lw	$t1 12($a0)
	beqz	$t1 label169
	la	$a0 PlusStackOpr_protObj
	jal	Object.copy
	jal	PlusStackOpr_init
	sw	$a0 0($sp)
	addiu	$sp $sp -4
	lw	$a0 12($s0)
